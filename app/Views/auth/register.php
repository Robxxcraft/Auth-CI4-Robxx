...
<section>
  ...
  <div class="text-center display-6" style="font-weight: bold;">Register</div>
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="<?= base_url('images/register.svg') ?>" class="img-fluid"
          alt="Sample image">
      </div>
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form class="mt-5" action="/register" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
          ...
          <span class="text-danger"><?= isset($validation) && $validation->hasError('name') ? $validation->getError('name') : '' ?></span>
          ...
          <img id="previewImg" width="120" height="120" src="<?= base_url('/images/placeholder.jpg') ?>">
          </div>
